...
Route::group(['prefix' => 'posts', 'namespace' => 'JaopMX\FaqPackage\Controllers'], function(){
...
Route::group(['prefix' => 'categories', 'namespace' => 'JaopMX\FaqPackage\Controllers'], function(){
    Route::get('/', 'CategoryController@index')->name('categories.index');
    Route::post('/store', 'CategoryController@store')->name('categories.store');
    Route::post('/update', 'CategoryController@update')->name('categories.update');
});

Route::group(['prefix' => 'resources', 'namespace' => 'JaopMX\FaqPackage\Controllers'], function(){
